...
<div class="body-box" style="float:right">
	<form id="jvForm" action="../tfastadd.do" method="post" onsubmit="return chkAll()">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="title" id="nulls" maxlength="100"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="content" id="nullss" maxlength="100"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="Wdate" name="ctime" onclick="WdatePicker()" maxlength="80" />
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="cman" id="cman" maxlength="100"/>
