...
<div style="margin-top:15px;">
	...
	<div style="float:right"><a href="list.do?isenabled=${QUERY.isenabled}&loginname=${QUERY.loginname}">第一页</a>
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="list.do?page=${(PAGE-1)<=0?1:(PAGE-1)}&isenabled=${QUERY.isenabled}&loginname=${QUERY.loginname}">上一页</a>
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="list.do?page=${PAGE+1>PAGECONT?PAGECONT:PAGE+1}&isenabled=${QUERY.isenabled}&loginname=${QUERY.loginname}">下一页</a>
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="list.do?page=${PAGECONT}&isenabled=${QUERY.isenabled}&loginname=${QUERY.loginname}">最后页</a>&nbsp;&nbsp;&nbsp;&nbsp;当前第${PAGE}页 /共${PAGECONT}页</div>
</div>
</body>
</html>